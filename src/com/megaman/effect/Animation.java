...
public class Animation {
    ...
    private int currentFrame; // biến lưu giữa cho ta biết đang vẽ frame nào
    ...
    private boolean drawRectFrame; // lấy thêm cái cái phần khung ảnh xong quanh hình dễ quan xác độ trộng của hình
    ...
    //Tạo animation bằng 1 animation khác
